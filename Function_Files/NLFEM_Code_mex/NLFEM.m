...
if (strcmp(fem.MatModel,'Bilinear')==1)&&(fem.MatParam(1)==fem.MatParam(2))
  ...
  fem.RN = nRes/nRes0; % Store ||R||/||Fext||
end
...
if strcmp(fem.MEX,'Yes')==1
  Compile_mex_file;
  [k0, f_NL, Psi] = Global_K_compile_mex(fem.ElemNDof,fem.Element,...
               fem.MatModel,fem.MatCase,fem.MatParam,fem.Thickness,E,...
               fem.W,fem.dNdxi,fem.Node,U);
elseif strcmp(fem.MEX,'No')==1
  [k0, f_NL, Psi] = Global_K_compile(fem.ElemNDof,fem.Element,...
               fem.MatModel,fem.MatCase,fem.MatParam,fem.Thickness,E,...
               fem.W,fem.dNdxi,fem.Node,U);
else
